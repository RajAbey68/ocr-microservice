/**
 * OCR Microservice — Express app setup (no server start).
 *
 * Exports the Express app for use by both the standalone server (src/index.ts)
 * and Vercel serverless (api/index.ts).
 *
 * POST /ocr       — Accepts { imageBase64, mimeType?, mode? }
 * POST /ocr/pdf   — Accepts { pdfBase64 }
